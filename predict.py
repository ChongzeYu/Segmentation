...
def parse_args():
    ...
    parser.add_argument('--dataset', default="TAS500", help="dataset: TAS500")
...
def predict(args, test_loader, model):
    """ only works for test dataloader
    args:
    ...
    for i, (input, size, name) in enumerate(test_loader):
        ...
        save_predict(output, name[0], args.save_seg_dir)
...
def test_model(args):
    ...
    _, testLoader = build_dataset_test(args.dataset, args.num_workers, mode="test")
